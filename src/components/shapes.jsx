...
//         <button className="btn" disabled={index <= 0}  style={{ backgroundColor : toggle ? "white" : "black" ,color : toggle ? "black" : "red" ,transition : "all 1s"}} onClick={prevbtn}>&lt;</button>
//         <button className="btn" disabled={index >= array.length - 1} style={{ backgroundColor : toggle ? "white" : "black",color : toggle ? "black" : "red" ,transition : "all 1s"}} onClick={nextbtn}>&gt;</button>
//       </div>
...
const ImageColorChanger = () => {
  ...
  const imagesArray = [
    Pictures.rectangle,Pictures.circle,Pictures.sqaure,Pictures.star,Pictures.moon
  ];
